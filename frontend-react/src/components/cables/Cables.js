    ...
    render() {
        ...
        return (
            ...
            <div className="center">
                    ...
                    <section id="content">
                    <h1 className="subheader">Cables</h1>
                        

                        {
                                    
                            this.state.products.filter(product => product.name.includes('Cables') || product.name.includes('Cable') || product.name.includes('cables') || product.name.includes('cable')).map((filteredName, i) => {
