...
class Portatiles extends Component {
    ...
    render() {
        ...
        if(this.state.status === 'deleted'){
            this.getProducts();
            return(
                <Redirect to={'/portatiles'}></Redirect>
            )
        }
        ...
        return (
            ...
            <div className="center">
                    ...
                    <section id="content">
                    <h1 className="subheader">Portátiles</h1>
                        
                        
                        {
                                    
                            this.state.products.filter(product => product.name.includes('Portátil') || product.name.includes('portatil') || product.name.includes('portátil') || product.name.includes('Portatil')).map((filteredName, i) => {
