...
class Adaptadores extends Component {
    ...
    render() {
        ...
        if(this.state.status === 'deleted'){
            this.getProducts();
            return(
                <Redirect to={'/adaptadores'}></Redirect>
            )
        }
        ...
        return (
            ...
            <div className="center">
                    ...
                    <section id="content">
                    <h1 className="subheader">Adaptadores</h1>
                        
                        {
                                    
                            this.state.products.filter(product => product.name.includes('Adaptadores') || product.name.includes('adaptadores') || product.name.includes('Adaptador') || product.name.includes('adaptador')).map((filteredName, i) => {
